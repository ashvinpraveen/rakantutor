                        ...
                        <Accordion type="single" collapsible className="gap-4 flex flex-col">
                            {faqs.map((faq, index) => (
                                <BlurFade key={index} delay={0.2 + index * 0.05} inView>
                                    <AccordionItem
                                        value={`item-${index}`}
                                        className="bg-zinc-950/50 border border-zinc-900 px-8 py-2 hover:border-cyan-500/30 transition-all duration-300 group data-[state=open]:border-cyan-500/50"
                                    >
