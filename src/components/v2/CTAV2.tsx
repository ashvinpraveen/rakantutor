...
const CTAV2 = () => {
    return (
        <section className="relative py-40 overflow-hidden bg-black">
            ...
            {/* Background Glows */}
            <div
                className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-full max-w-4xl h-[400px] pointer-events-none animate-pulse"
            ...
            <div className="container relative z-10 mx-auto px-6 text-center">
                <div className="max-w-5xl mx-auto space-y-16">
                    <BlurFade inView>
                        <h2 className="text-6xl md:text-9xl font-black tracking-tighter text-white uppercase leading-[0.8]" style={{ fontFamily: "'Orbitron', sans-serif" }}>
                            INITIATE <br />
                    ...
                    <BlurFade inView delay={0.2}>
                        <p className="text-2xl md:text-3xl text-zinc-400 font-light max-w-3xl mx-auto leading-tight">
                            What are you waiting for? Join Malaysia's largest AI competition for youths.
                        </p>
                    </BlurFade>
                    ...
                    <BlurFade inView delay={0.3}>
                        <div className="flex flex-col items-center justify-center">
                            <div className="relative group">
                                ...
                                <Button
                                    asChild
                                    className="relative h-24 px-16 rounded-lg bg-black border-2 border-cyan-500 text-cyan-400 font-black text-4xl uppercase tracking-tighter hover:bg-cyan-950 transition-all hover:scale-110 active:scale-95 shadow-[0_0_30px_rgba(6,182,212,0.5)]"
            ...
            <motion.div
                className="absolute left-0 w-full h-[1px] bg-cyan-500/10 blur-sm"
                animate={{ top: ['0%', '100%'] }}
