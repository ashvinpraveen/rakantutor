...
const HeroV2 = () => {
  ...
  return <section className="relative min-h-screen lg:h-screen flex flex-col items-center justify-center pt-20 px-4 overflow-hidden bg-black transition-colors duration-500">
            ...
            <div className="absolute top-1/2 left-1/4 -translate-y-1/2 w-[800px] h-[800px] pointer-events-none animate-pulse-neon" style={{
      background: 'radial-gradient(circle at center, rgba(6, 182, 212, 0.15) 0%, transparent 70%)'
    }} />
            <div className="absolute top-1/2 right-1/4 -translate-y-1/2 w-[800px] h-[800px] pointer-events-none animate-pulse-neon" style={{
      background: 'radial-gradient(circle at center, rgba(37, 99, 235, 0.15) 0%, transparent 70%)',
      animationDelay: '1s'
    }} />
            <div className="absolute top-1/4 left-1/2 -translate-x-1/2 w-[1000px] h-[600px] pointer-events-none" style={{
      background: 'radial-gradient(ellipse at center, rgba(6, 182, 212, 0.05) 0%, transparent 80%)'
    }} />
            ...
            <div className="absolute top-36 left-12 hidden lg:block space-y-1 pointer-events-none opacity-60" style={{
      fontFamily: "'Share Tech Mono', monospace"
            ...
            <div className="absolute bottom-12 right-8 hidden lg:block text-right space-y-1 pointer-events-none opacity-60" style={{
      fontFamily: "'Share Tech Mono', monospace"
    }}>
            ...
            <div className="container relative z-10 max-w-5xl mx-auto flex flex-col items-center text-center">
                ...
                <BlurFade delay={0.1}>
                    <div className="relative inline-block mb-6">
                        <motion.img src={heroAiV2} alt="AI Logo" className="w-full max-w-[160px] md:max-w-[200px] h-auto" initial={{
            scale: 0.9,
            opacity: 0
          }} animate={{
            scale: 1,
            ...
            ease: "easeOut"
                ...
                {/* Main Title */}
                <div className="mb-6">
                    <h1 className="text-4xl md:text-5xl lg:text-7xl font-black tracking-tight text-white uppercase leading-tight" style={{
          fontFamily: "'Orbitron', sans-serif"
                ...
                <div className="space-y-10 max-w-2xl mx-auto">
                    <BlurFade delay={BLUR_FADE_DELAY * (titleWords.length + 2)}>
                        <p className="text-base text-cyan-50/80 tracking-wide uppercase leading-relaxed md:text-lg font-normal" style={{
            fontFamily: "'Outfit', sans-serif"
          }}>
                            Malaysia's largest AI competition for students.
                        </p>
                    </BlurFade>
                    ...
                    <BlurFade delay={0.5}>
                        <div className="flex flex-col items-center gap-4">
                            <div className="relative group">
                                ...
                                <Button asChild className="relative h-12 px-8 rounded-lg bg-black border border-cyan-500/50 text-cyan-400 font-bold text-lg uppercase tracking-[0.1em] hover:bg-cyan-950 transition-all hover:scale-105 active:scale-95" style={{
            ...
            <div className="absolute top-0 left-0 w-full h-full overflow-hidden pointer-events-none opacity-30">
                ...
                <motion.div className="absolute left-0 w-full h-[2px] bg-cyan-500/20 blur-sm" animate={{
        top: ['-10%', '110%']
      }} transition={{
        duration: 10,
        repeat: Infinity,
