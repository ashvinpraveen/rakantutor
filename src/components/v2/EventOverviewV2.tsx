...
const CountUp = ({
  ...
  return <div ref={ref} className="text-4xl md:text-6xl font-black text-white italic tracking-tighter leading-none neon-text-cyan">
            {displayValue}
            {suffix || ""}
        </div>;
};
const EventOverviewV2 = () => {
  return <section id="overview" className="relative py-32 bg-black overflow-hidden">
                ...
                <div className="flex flex-col-reverse md:flex-row items-center gap-16 lg:gap-24">
                    <div className="w-full md:w-1/2 space-y-10">
                        <div className="space-y-6">
                            <h2 className="text-4xl md:text-5xl lg:text-6xl font-black text-white uppercase tracking-tighter leading-none" style={{
              fontFamily: "'Orbitron', sans-serif"
            }}>NAIC 2026:
OVERVIEW<br /><span className="text-cyan-500">OVERVIEW</span>
                            </h2>
                    ...
                    <div className="w-full md:w-1/2 relative group">
                        <div className="absolute inset-0 -z-10 group-hover:scale-110 transition-transform duration-700 animate-pulse" style={{
            background: 'radial-gradient(circle at center, rgba(6, 182, 212, 0.15) 0%, transparent 70%)'
          }} />
                        <img src={heroGraphic} alt="Competition overview graphic" className="w-full max-w-lg mx-auto drop-shadow-[0_0_50px_rgba(6,182,212,0.3)] transition-all duration-500 group-hover:rotate-1 group-hover:scale-105" />
                        {/* Tech Corners */}
