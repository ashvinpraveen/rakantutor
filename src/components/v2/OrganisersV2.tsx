...
const OrganisersV2 = () => {
    return (
        <section className="relative py-16 md:py-24 px-4 bg-black border-t border-cyan-500/10">
            {/* Background Elements */}
                ...
                <BlurFade inView>
                    <div className="flex flex-col items-center gap-12">
                        ...
                        <div className="text-center">
                            <p className="text-xs md:text-sm font-black text-cyan-500/50 uppercase tracking-[0.3em] mb-2" style={{ fontFamily: "'Share Tech Mono', monospace" }}>
                                Organised By
                            </p>
